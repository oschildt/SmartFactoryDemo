...
function report_messages()
{
    ...
    if (!empty($response["FOCUS_ELEMENT"])) {
        echo "Focus element: " . $response["FOCUS_ELEMENT"] . "<br>";
    }
    if (!empty($response["ERROR_ELEMENT"])) {
        echo "Error element: " . $response["ERROR_ELEMENT"] . "<br>";
    }
    if (!empty($response["ACTIVE_TAB"])) {
        echo "Active tab: " . $response["ACTIVE_TAB"] . "<br>";
    }
