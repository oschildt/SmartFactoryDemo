...
function test_database()
{
    ...
    $dbw->execute_query("select datalength(text_data) tds, datalength(blob_data) bds from large_data where id = 1");
    ...
    $dbw->execute_query("create table #temp (email varchar(255) default null, last_name varchar(500) not null, first_name varchar(500) default null)");
